...
def main_air_quality_check():
    ...
    print("🌤️  Simple Air Quality Checker")
    ...
    estimated_aqi, similar_historical_days = find_days_with_similar_air(user_pm25, user_pm10, cleaned_air_data)
    air_recommendations = what_should_you_do_about_this_air(estimated_aqi)
    
    # Provide the personalized report
    create_personal_air_report(user_pm25, user_pm10, estimated_aqi, air_recommendations, similar_historical_days)
